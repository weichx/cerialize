import {
  autoserializeAs, autoserializeAsArray, autoserializeAsJson, autoserializeAsMap, autoserializeUsing,
  serializeAs, serializeAsArray, serializeAsJson, serializeAsMap, serializeUsing
    ...
    function runTests(blockName : string, serializeAs : any, serializeAsMap : any, serializeAsArray : any, serializeAsJson : any) {
      describe(blockName, function () {
        ...
        it("serializes basic primitive", function () {
          ...
          s.value1 = true;
          s.value2 = 100;
          const json = Serialize(s, Test) as JsonObject;
        ...
        it("serializes nested types", function () {
          ...
          s.value1 = true;
          s.value2 = 100;
          const json = Serialize(x, Test0) as JsonObject;
        ...
        it("serializes doubly nested types", function () {
          ...
          s.value1 = true;
          s.value2 = 100;
          const json = Serialize(z, Test1) as JsonObject;
          expect(json["test"]).toEqual({
            test: {
              value0: null,
              value1: true,
    ...
    function runTests(blockName : string, serializeAs : any, serializeAsMap : any, serializeAsArray : any, serializeAsJson : any) {
      ...
      describe(blockName, function () {
        ...
        it("serializes nested maps", function () {
          ...
          const json = Serialize(t, Test);
          expect(json["values"]).toEqual({
            v0: { value: { v00: 1, v01: 2 } }, v1: { value: { v10: 2, v11: 2 } }, v2: { value: { v20: 3, v21: 2 } }
          });
        });
